...
public class JNAeratorCommandLineArgs {
	...
	public enum OptionDef {
        ...
        ParseInOneChunk(    "-parseInOneChunk",     "Parses all the input files in one chunk, instead of splitting the input into multiple smaller parts (in theory everything should be parsed in one chunk, but in practice this means errors are not isolated from the rest of the parsing)"),
