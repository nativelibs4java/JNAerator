...
//					name = name.clone();
    ...
    public Struct notifyBeforeWritingClass(Identifier fullClassName, Struct interf, Signatures signatures, String currentLibrary) {
        ...
        String runtimeSpecificHelp = config.runtime == JNAeratorConfig.Runtime.BridJ
                ? "or <a href=\"https://bridj.googlecode.com/\">BridJ</a> "
                : ", <a href=\"https://rococoa.dev.java.net/\">Rococoa</a>, "
                + "or <a href=\"https://jna.dev.java.net/\">JNA</a>";
        interf.addToCommentBefore(
                "This file was autogenerated by <a href=\"https://jnaerator.googlecode.com/\">JNAerator</a>, ",
                "a tool written by <a href=\"https://ochafik.com/\">Olivier Chafik</a> that <a href=\"https://code.google.com/p/jnaerator/wiki/CreditsAndLicense\">uses a few opensource projects.</a>.",
                "For help, please visit <a href=\"https://nativelibs4java.googlecode.com/\">NativeLibs4Java</a> "
                + runtimeSpecificHelp + ".");
